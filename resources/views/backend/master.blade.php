    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{!! url('admin') !!}" class="logo">
          ...
          <span class="logo-lg"><img src="{{ asset('public/images/logo-white.png') }}" width="200px" alt="logo" class="logo-default"/></span>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            ...
                            <img src="{{ asset('public/images/avatar3.jpg') }}" class="img-circle" alt="User Image" />
                          </div>
                          <h4>
                            Support Team
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="{{ asset('public/images/amx.jpg') }}" class="img-circle" alt="User Image" />
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="{{ asset('public/images/avatar.jpg') }}" class="img-circle" alt="User Image" />
                          </div>
                          <h4>
                            Developers
                      ...
                      <li>
                        <a href="#">twitter-icon.png
                          <div class="pull-left">
                            <img src="{{ asset('public/images/twitter-icon.png') }}" class="img-circle" alt="User Image" />
                          </div>
                          <h4>
                            Sales Department
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="{{ asset('public/images/aa.jpg') }}" class="img-circle" alt="User Image" />
                          </div>
                          <h4>
                            Reviewers
          ...
          <div class="pull-left">
                       <img src="{{ asset('public/images/avatar.jpg') }}" class="img-circle" alt="User Image" width="20px" />
         </div>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview @yield('user')">
              ...
              <ul class="treeview-menu">
                <li class="@yield('them_user')"><a href="{!! url('admin/user/add') !!}"><i class="fa fa-circle-o"></i> Thêm tài khoản</a></li>
                <li class="@yield('list_user')"><a href="{!! url('admin/user/list') !!}"><i class="fa fa-circle-o"></i> Danh sách tài khoản</a></li>
